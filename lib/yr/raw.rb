  ...
  module Raw
    ...
    class Base
      ...
      def parse(query_or_uri = {})
        ...
        if res["content-type"][0..7] == "text/xml" or res["content-type"][0..14] == "application/xml"
    ...
    ExtremesWWC = Base.new(:extremesWWC, 1.2)
    Forestfireindex = Base.new(:forestfireindex, 1.1)
    Geosatellite = Base.new(:geosatellite, 1.3)
    Icemap = Base.new(:icemap, 1.0)
    Locationforecast = Base.new(:locationforecast, 1.9)
    Mountaineasterobservations = Base.new(:mountaineasterobservations, 1.0)
    OceanForecast = Base.new(:oceanforecast, 0.9)
    Polarsatellite = Base.new(:polarsatellite, 1.1)
    Radar = Base.new(:radar, 1.4)
    ...
    Sunrise = Base.new(:sunrise, 1.1)
    Textforecast = Base.new(:textforecast, 1.6)
    ...
    Weathericon = Base.new(:weathericon, 1.1)
